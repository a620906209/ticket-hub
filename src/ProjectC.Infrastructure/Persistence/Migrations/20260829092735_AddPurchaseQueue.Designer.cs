...
namespace ProjectC.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260829092735_AddPurchaseQueue")]
    partial class AddPurchaseQueue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectC.Domain.Tickets.TicketType", b =>
                {
                    ...
                    b.ToTable("TicketTypes", null, t =>
                        {
                            t.HasCheckConstraint("CK_TicketTypes_RequiresSeat_AvailableQuantity", "(\"RequiresSeat\" = TRUE AND \"AvailableQuantity\" IS NULL) OR (\"RequiresSeat\" = FALSE AND \"AvailableQuantity\" >= 0)");
                        });
                });
            ...
            modelBuilder.Entity("ProjectC.Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.HasOne("ProjectC.Domain.Tickets.TicketType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectC.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("ProjectC.Domain.Orders.OrderItem", null)
                        .WithMany()
